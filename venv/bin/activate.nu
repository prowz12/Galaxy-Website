...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/emobilis/PycharmProjects/midMorningTemplateOne /venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/emobilis/PycharmProjects/midMorningTemplateOne /venv/bin/deactivate.nu'
